...
public class UserServiceTest {
	...
	public void serUp() {
		users = Arrays.asList(
					new User("j01_125","노명진01","1234",Level.BASIC,MIN_LOGIN_COUNT_FOR_SILVER-1,0,"nmjgo7321@gmail.com","2019/08/23"),
					new User("j02_125","노명진02","1234",Level.BASIC,MIN_LOGIN_COUNT_FOR_SILVER,0,"nmjgo7321@gmail.com","2019/08/23"), //Basic -> Silver
					new User("j03_125","노명진03","1234",Level.SILVER,60,MIN_RECOMMEND_COUNT_FOR_GOLD-1,"nmjgo7321@gmail.com","2019/08/23"),
					new User("j04_125","노명진04","1234",Level.SILVER,60,MIN_RECOMMEND_COUNT_FOR_GOLD,"nmjgo7321@gmail.com","2019/08/23"), //Silver -> Gold
					new User("j05_125","노명진05","1234",Level.GOLD,99,99,"nmjgo7321@gmail.com","2019/08/23")
				);
	}
	...
	public void upgradeAllOrNothing() throws SQLException {
		...
		testUserService.setMailSender(sendMail);
